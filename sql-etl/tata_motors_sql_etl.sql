...
copy membership
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Membership.csv'
DELIMITER ','
CSV HEADER;
...
COPY customer
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Customer.csv'
DELIMITER ','
CSV HEADER;

-- Load Employee Details Dataset
copy employee_details
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Employee_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Shipment Details Dataset
copy shipment_details
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Shipment_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Status Dataset
copy status
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Status.csv'
DELIMITER ','
CSV HEADER;

-- Load Payment Details Dataset
copy payment_details
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Payment_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Employee Shipment Dataset
copy employee_manages_shipment
FROM 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\employee_manages_shipment.csv'
DELIMITER ','
CSV HEADER;
...
TO 'R:\Tata-Motors-Integrated-Operations-Analysis-main\dataset\Customer_Payments.csv'
DELIMITER ','
CSV HEADER;
